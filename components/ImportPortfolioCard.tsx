...
import { Upload, Loader2, AlertCircle, CheckCircle, Smartphone } from 'lucide-react';
...
export default function ImportPortfolioCard({ onImport, className }: ImportPortfolioCardProps) {
            ...
            >
                ...
                {isProcessing ? (
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-3">
                        ...
                        <span className="text-lg font-bold text-emerald-400">Imported!</span>
                    </div>
                ) : (
                    <>
                        ...
                        <div className="relative z-10 space-y-1">
                            <h3 className="text-lg font-bold text-white group-hover:text-emerald-400 transition-colors">Import Portfolio</h3>
